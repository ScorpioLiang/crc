...
/**
 * @brief       使用查表法计算CRC16值
 * @note        初始值0XFFFF，异或值0x0000，LSB First，多项式8005
 * @param[in]   uint8_t *pData:需要计算的数据指针
 * @param[in]   uint16_t usDataLen:需要计算的数据长度
 * @return      计算结果
 */
...
/**
 * @brief       使用查表法计算CRC16值
 * @note        初始值0XFFFF，异或值0x0000，MSB First，多项式8005
 * @param[in]   uint8_t *pData:需要计算的数据指针
 * @param[in]   uint16_t usDataLen:需要计算的数据长度
 * @return      计算结果
 */
